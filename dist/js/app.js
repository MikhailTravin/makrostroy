 ...
 */
    ...
    (() => {
        ...
        function rangeInit() {
            ...
            ratingFilters.forEach((ratingFilter => {
                if (ratingFilter) {
                    ...
                    if (!priceStart || !priceEnd || !resetButton) return;
            ...
            function formatValue(value, suffix) {
                if ("₽" === suffix) return new Intl.NumberFormat("ru-RU").format(value) + " ₽"; else if ("%" === suffix) return value + " %"; else if ("лет" === suffix) return value + " лет";
                return value;
            }
            function initializeCalculatorBlock(sliderId, inputId, buttonsClass, options) {
                ...
                if (slider && input) {
                    ...
                    function updateActiveButton(value, id) {
                        if (buttons) {
                            ...
                            const activeButton = Array.from(buttons).find((button => {
                                ...
                                return Math.abs(buttonValue - value) < .1 && (!id || buttonId === id);
                            }));
                    ...
                    slider.noUiSlider.on("update", (function(values, handle) {
                        ...
                        const formattedValue = formatValue(rawValue, options.suffix);
                    ...
                    input.addEventListener("change", (function() {
                        ...
                        if (!isNaN(numericValue)) {
                            slider.noUiSlider.set(numericValue);
                            updateActiveButton(numericValue);
                        }
                    }));
                    if (buttons) {
                        buttons.forEach((button => {
                            button.addEventListener("click", (function() {
                                ...
                                input.value = formatValue(value, options.suffix);
                                updateActiveButton(value, id);
                            }));
                        }));
                        ...
                        if (initialActiveButton) {
                            ...
                            slider.noUiSlider.set(initialValue);
                            updateActiveButton(initialValue);
                        }
                    }
                }
            }
        ...
        if (productSlider) productSlider.forEach((sliderContainer => {
        ...
        if (document.querySelector(".purchase-steps__slider")) new core(".purchase-steps__slider", {
        ...
        if (document.querySelector(".bottom-partnership-block__slider")) new core(".bottom-partnership-block__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (apartmentsSlider) apartmentsSlider.forEach((sliderContainer => {
        ...
        if (document.querySelector(".apartments-main-slider")) {
            const swiper = new core(".apartments-main-slider", {
        ...
        if (document.querySelector(".slider-product-card__slider")) new core(".slider-product-card__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".construction-progress__slider")) new core(".construction-progress__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".residential-complex__slider")) new core(".residential-complex__slider", {
        ...
        function handleMediaQueryChange(e) {
            if (e.matches) new simplebar_esm(simpleBarElement, {
                autoHide: true,
                scrollbarMaxSize: 20
            }); else if (simpleBarElement.SimpleBar) simpleBarElement.SimpleBar.unMount();
        }
...
***************************************************************************** */
        ...
        function indents() {
            ...
            if (residentialComplex) if (document.documentElement.clientWidth > 767.98) {
        ...
        if (spollerItems) {
            ...
            const handleClickOnItem = item => {
                item.addEventListener("click", (() => {
                    ...
                    if (document.documentElement.classList.contains("menu-hovered")) bodyLock(); else bodyUnlock();
                }));
            };
            const mediaQuery = window.matchMedia("(max-width: 991.98px)");
            ...
            const setupEventListeners = () => {
                ...
                spollerItems.forEach((item => {
                    ...
                    if (hasArrow) if (mediaQuery.matches) handleClickOnItem(item); else {
                        handleHover(item);
            ...
            document.addEventListener("click", (e => {
                if (!e.target.closest(".spollers-menu__item") && !e.target.closest(".spollers-menu__simplebar") && !e.target.closest(".menu__icon")) {
                    document.documentElement.classList.remove("menu-hovered");
                    spollerItems.forEach((item => {
                        item.classList.remove("menu-hovered");
                    }));
            ...
            if (spollersMenuSimplebar) spollersMenuSimplebar.addEventListener("click", (e => {
                e.stopPropagation();
            }));
        }
        ...
        if (filterButtonMob.length > 0) {
            ...
            function resetFilters(filterContent) {
                ...
                selects.forEach((select => {
                    ...
                    select.querySelector(".select__title");
            ...
            filterButtonMob.forEach(((button, index) => {
                button.addEventListener("click", (function() {
                    ...
                    if (filterContent) openFilters(filterContent);
                }));
            }));
            closeButtons.forEach((closeButton => {
                closeButton.addEventListener("click", (function() {
                    const filterContent = closeButton.closest(".filter-tabs__content");
                    if (filterContent) closeFilters(filterContent);
                }));
            }));
            resetButtons.forEach((resetButton => {
                resetButton.addEventListener("click", (function() {
                    const filterContent = resetButton.closest(".filter-tabs__content");
                    if (filterContent) resetFilters(filterContent);
                }));
            }));
            document.addEventListener("click", (function(event) {
                filterContents.forEach((filterContent => {
                    if (!filterContent.contains(event.target) && !event.target.closest(".filter-tabs__button-mob")) closeFilters(filterContent);
                }));
            }));
        }
        ...
        if (file) {
            ...
            function renderFileList() {
                ...
                selectedFiles.forEach(((file, index) => {
                    ...
                    closeButton.addEventListener("click", (() => removeFile(index)));
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            productCards.forEach(((card, index) => {
                ...
                azimuthInputs.forEach((input => {
                    input.addEventListener("change", (function() {
                        if (this.checked) {
                            parseInt(this.value);
                            let rotationAngle;
                            if ("Утро" === this.nextElementSibling.textContent.trim()) rotationAngle = initialRotation - 90; else if ("Вечер" === this.nextElementSibling.textContent.trim()) rotationAngle = initialRotation + 90; else rotationAngle = initialRotation;
                ...
                if (defaultInput) defaultInput.dispatchEvent(new Event("change"));
            }));
        }));
